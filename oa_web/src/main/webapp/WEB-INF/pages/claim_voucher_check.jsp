            ...
            <div class="panel heading-border">
                <div class="panel-body bg-light">
                    ...
                    <div class="section row">
                        ...
                        <div class="col-md-4"><fmt:formatDate value="${claimVoucher.createTime}" pattern="yyyy-MM-dd hh:mm"/> </div>
                    </div>
                    <div class="section row">
                    ...
                    <c:forEach items="${records}" var="record">
                        ...
                        <div class="col-md-3"><fmt:formatDate value="${record.dealTime}" pattern="yyyy-MM-dd hh:mm"/></div>
