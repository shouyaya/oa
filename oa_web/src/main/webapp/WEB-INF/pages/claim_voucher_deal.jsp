...
<%@ page import="com.yzy.global.Constant" %>
                    ...
                    <div class="row">
                        <div class="hidden-xs hidden-sm col-md-3">
                            <div class="btn-group">
                                ...
                                <button type="button" class="btn btn-default light" onclick="javascript:window.location.href='${pageContext.request.contextPath}/claim_voucher/to_add';">
                ...
                <div class="panel-body pn">
                    <table id="message-table" class="table admin-form theme-warning tc-checkbox-1">
                        ...
                        <tr class="message-unread">
                            ...
                            <td><fmt:formatDate value="${cv.createTime}" pattern="yyyy-MM-dd hh:mm"/></td>
                            <td>
